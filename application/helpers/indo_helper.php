...
if ( ! function_exists('waktuawal'))
{
	function waktuawal($waktu)
	{
		$waktuawal = date("H:i:s", strtotime($waktu));
		return $waktuawal;
	}
}

if ( ! function_exists('waktuakhir'))
{
	function waktuakhir($waktu)
	{
		$waktuakhir = date("h:i:s A", strtotime($waktu));
		return $waktuakhir;
	}
}