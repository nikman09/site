...
<div class="panel-body">
	<?php pesan_get('msg',"Berhasil Menambahkan Berita","Gagal Menambahkan Berita") ?>
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>administrator/beritatambah"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-12">
                        ...
                        <select class="form-control" name="beritakategori" id="beritakategori" >
                            ...
                            <?php
                                foreach($beritakategori->result_array() as $row) {
                                    ...
                                    echo "<option value='".$row['id_beritakategori']."'>";
...
<footer class="panel-footer text-right bg-light lter">
	...
	&nbsp
	<a href="<?php echo base_url('administrator/berita') ?>" class="btn btn-default btn-s-xs  btn-icon icon-left">
