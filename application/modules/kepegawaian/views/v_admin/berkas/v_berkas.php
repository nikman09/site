...
<div class="modal fade" id="ktpmodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadktp" method="post" enctype="multipart/form-data" id="form">
...
<div class="modal fade" id="kartunikahmodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadkartunikah" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
...
<div class="modal fade" id="kariskarsumodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadkariskarsu" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
...
<div class="modal fade" id="kartukeluargamodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadkartukeluarga" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
...
<div class="modal fade" id="bpjsmodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadbpjs" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
...
<div class="modal fade" id="taspenmodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadtaspen" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
...
<div class="modal fade" id="skcpnsmodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadskcpns" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
...
<div class="modal fade" id="skpnsmodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadskpns" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
...
<div class="modal fade" id="karpegmodal">
    <div class="modal-dialog">
        <div class="modal-content" id="modal-lihat">
            ...
            <form role="form" class="validate" action="<?php echo base_url() ?>kepegawaian/admin/uploadkarpeg" method="post" enctype="multipart/form-data" id="form">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
						<input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $data['id_pegawai'] ?>">
