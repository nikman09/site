	...
	<div class="login-container">
		...
		<div class="login-form" >
			<div class="login-content">
				...
				<form method="post" role="form" id="form_login" class="validate" action="<?php echo base_url() ?>kepegawaian/login<?php if (isset($_GET['m'])) echo "?m=".$_GET['m'].""; ?>">
				<input type="hidden" name="<?=$csrf['name']?>" value="<?=$csrf['hash']?>">
					<div class="">
					<?php 
					if (isset($gagal))
						pesanvar($gagal,"NIP atau password yang dimasukkan salah","NIP atau password yang dimasukkan salah","Klik CAPTCHA untuk verifikasi login") ?>
						<div class="form-group">
							<div class="input-group">
								<div class="input-group-addon">
									<i class="entypo-mail"></i>
								</div>
								<input type="text" class="form-control" name="nip" id="nip"  placeholder="NIP" autocomplete="off" value="<?php echo set_value('nip'); ?>"
								/>
							</div>
						</div>
						<div class="form-group">
