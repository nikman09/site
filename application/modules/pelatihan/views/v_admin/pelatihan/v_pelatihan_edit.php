...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>pelatihan/admin/pelatihanedit"	method="post"  enctype="multipart/form-data" id="form"> 	
	<div class="row">
			<div class="col-md-12">
...
<footer class="panel-footer text-right bg-light lter">
	...
	&nbsp
    <a href="<?php echo base_url('pelatihan/admin/pelatihanedit?id='.$data['id_pelatihan'].'') ?>" class="btn btn-default btn-s-xs  btn-icon icon-left">
