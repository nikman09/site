...
<div class="row">
    <div class="col-md-12">
        <?php pesan_get('msg',"Berhasil Menambah Pengumuman","Berhasil Mengedit Pengumuman","Berhasil Menghapus Pengumuman") ?>
            <a href="<?php echo base_url() ?>pelatihan/admin/pengumumantambah" style="margin: 5px 0 10px 0px" class="btn  btn-primary tambah  btn-icon icon-left">
					...
					foreach($data->result_array() as $row){
						echo "
							<tr>
								<td>
								<div>
									<a href='".base_url("pelatihan/admin/pengumumanedit?id=".$row['id_pengumuman']."")."' class='btn btn-primary btn-xs' title='Edit/Lihat' id='".$row['id_pengumuman']."'><i class='fa fa-edit' id='".$row['id_pengumuman']."'  ></i></a>
