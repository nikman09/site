...
<div class="row">
    <div class="col-md-12">
        <?php pesan_get('msg',"Berhasil Menambah Pelatihan","Berhasil Mengedit Pelatihan","Berhasil Menghapus Pelatihan") ?>
            <a href="<?php echo base_url() ?>simanis/admin/pelatihantambah" style="margin: 5px 0 10px 0px" class="btn  btn-primary tambah  btn-icon icon-left">
					...
					foreach($data->result_array() as $row){
						echo "
                            <tr>
                                <td>
                                <div>
									<a href='".base_url("simanis/admin/pelatihanedit?id=".$row['id_pelatihan']."")."' class='btn btn-primary btn-xs' title='Edit/Lihat' id='".$row['id_pelatihan']."'><i class='fa fa-edit' id='".$row['id_pelatihan']."'  ></i></a>
