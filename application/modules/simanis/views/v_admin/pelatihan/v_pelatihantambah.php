<ol class="breadcrumb bc-3">
    ...
    <li>
        <a href="<?php echo base_url() ?>simanis/admin/pelatihan">
...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal"  action="<?php echo base_url() ?>simanis/admin/pelatihantambah"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-12">
