<ol class="breadcrumb bc-3">
    ...
    <li>
        ...
        <a href="<?php echo base_url() ?>simanis/admin/pengumuman">
...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>simanis/admin/pengumumanedit"	method="post"  enctype="multipart/form-data" id="form"> 	
...
<footer class="panel-footer text-right bg-light lter">
    ...
    <a href="<?php echo base_url('simanis/admin/pengumumanedit?id='.$data['id_pengumuman'].'') ?>" class="btn btn-default btn-s-xs  btn-icon icon-left">

		<i class="fa fa-refresh"></i> Reset</a>

	<a href="<?php echo base_url('simanis/admin/pengumuman') ?>" class="btn btn-default btn-s-xs  btn-icon icon-left">
