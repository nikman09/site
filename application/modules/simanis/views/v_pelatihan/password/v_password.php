...
<div class="container">
	<div class="row vspace">
		...
		<?php if (isset($gagal))
				pesanvar2($gagal,"Gagal Mengganti Password, Password Lama yang dimasukkan salah!","Gagal Mengganti Password !") ?>
                    <div class="row">
					
					<div class="col-md-6">
					<h3>Ganti Password</h3>
					<hr/>
						<form id="form" role="form" class="validate" action="<?php echo base_url() ?>simanis/password" method="post" >
