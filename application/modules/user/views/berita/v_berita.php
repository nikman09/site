...
<div class="row">
    <div class="col-md-12">
        <?php pesan_get('msg',"Berhasil Menambah Berita","Berhasil Mengedit Berita","Berhasil Menghapus Berita") ?>
            <a href="<?php echo base_url() ?>user/beritatambah" style="margin: 5px 0 10px 0px" class="btn  btn-primary tambah">
					...
					foreach($data->result_array() as $row){
						echo "
							<tr>
								<td>
								<div>
									<a href='".base_url("user/beritaedit?id=".$row['id_berita']."")."' class='btn btn-primary btn-xs' title='Edit/Lihat' id='".$row['id_berita']."'><i class='fa fa-edit' id='".$row['id_berita']."'  ></i></a>
