    ...
    {   
        ...
        if ($this->input->post()){
            ...
            $array=array(
                ...
                $exec = $this->m_saran->tambahdata($array);

                if ($exec) redirect(base_url("web/saran?msg=1"));

                else redirect(base_url("web/saran?msg=0"));

        }

        else {

            $this->layout->render('saran/v_saran',$variabel,'saran/v_saran_js');
