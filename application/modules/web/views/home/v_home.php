...
<div>
		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<section class="section bg-color-light section-height-3 border-0 m-0" style="padding-top: 20px;padding-bottom: 0px;">
					<div class="container pb-2">
						<div class="row">
							<div class="col-lg-4 text-center text-md-left mb-5 mb-lg-0"  data-appear-animation="fadeInRightShorter">
								<h2 class="text-color-dark font-weight-normal text-6" style="margin-bottom:0">Provinsi <strong class="font-weight-extra-bold"> Kalimantan Selatan</strong></h2>
								<img src="<?php echo base_url() ?>assets/front-end/web2/bahan/logo.png" class="img-fluid  mb-0" alt="">
								
							</div>
							<div class="col-lg-8" data-appear-animation="fadeInLeftShorter" >
							
							<iframe width="660" height="330" src="https://www.youtube.com/embed/1p_UBv8igEE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<section class="section section-height-3 bg-color-grey-scale-1 m-0 border-0" >
					<div class="container">
						<div class="row align-items-center justify-content-center">
							<div class="col-lg-6 pb-sm-4 pb-lg-0 pr-lg-5 mb-sm-5 mb-lg-0 appear-animation" data-appear-animation="fadeIn">
								<h2 class="text-color-dark font-weight-normal text-6 mb-2">Profil <strong class="font-weight-extra-bold">Dinas Perindustrian</strong></h2>
							...
							<div class="col-sm-8 col-md-6 col-lg-4 offset-sm-4 offset-md-4 offset-lg-2 mt-sm-5" style="top: 1.7rem;">
								...
								<img src="<?php echo base_url() ?>assets/front-end/web2/bahan/2.jpg" class="img-fluid position-absolute d-none d-sm-block appear-animation" data-appear-animation="expandIn" style="top: -33%; left: -29%;" alt="" />
								<img src="<?php echo base_url() ?>assets/front-end/web2/bahan/3.jpg" class="img-fluid position-relative appear-animation mb-2" data-appear-animation="expandIn" data-appear-animation-delay="600" alt="" />
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
					<div class="row mt-4">
						<div class="col-lg-12 text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">
							<h2 class="font-weight-normal text-6 mt-3 mb-5">Berita <strong class="font-weight-extra-bold">Terkini</strong></h2>
						</div>
					</div>
		...
		<!-- Vendor -->
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery/jquery.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery.appear/jquery.appear.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery.easing/jquery.easing.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery.cookie/jquery.cookie.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/popper/umd/popper.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/bootstrap/js/bootstrap.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/common/common.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery.validation/jquery.validate.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery.gmap/jquery.gmap.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/jquery.lazyload/jquery.lazyload.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/isotope/jquery.isotope.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/owl.carousel/owl.carousel.min.js"></script>
		...
		<script src="<?php echo base_url() ?>assets/front-end/web2/js/theme.js"></script>
		
		<!-- Current Page Vendor and Views -->
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
		<script src="<?php echo base_url() ?>assets/front-end/web2/vendor/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>

		<!-- Current Page Vendor and Views -->
		<script src="<?php echo base_url() ?>assets/front-end/web2/js/views/view.contact.js"></script>
		
		<!-- Theme Custom -->
		<script src="<?php echo base_url() ?>assets/front-end/web2/js/custom.js"></script>
		
		<!-- Theme Initialization Files -->
		<script src="<?php echo base_url() ?>assets/front-end/web2/js/theme.init.js"></script>
