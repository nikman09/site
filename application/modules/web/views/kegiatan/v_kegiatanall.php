					...
					<div class="container">
						<div class="row mt-5">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-9 font-weight-bold">Kegiatan</h1>
							...
							<div class="col-md-4">
								<article class="post post-medium border-0 pb-0 mb-5">
									...
									<div class="post-content">
										...
										<h2 class="font-weight-semibold text-5 line-height-6 mt-3 mb-2"><a href="blog-post.html"><?php  echo $row['judul']; ?></a></h2>
										...
										<div class="post-meta">
											...
											<span class="d-block mt-2"><a href="blog-post.html" class="btn btn-xs btn-light text-1 text-uppercase">Baca Lebih Lanjut</a></span>
										</div>
